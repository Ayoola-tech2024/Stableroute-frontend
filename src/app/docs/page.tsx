        ...
        <div className="mt-4 space-y-4">
          ...
          <div>
            ...
            <ul className="mt-1 list-inside list-disc space-y-1 text-sm text-neutral-700 dark:text-neutral-300">
              <li>
                <kbd className="rounded border border-neutral-300 bg-neutral-50 px-1 py-0.5 font-mono text-xs dark:border-neutral-700 dark:bg-neutral-900">
                  Ctrl+K
                </kbd>{' '}
                /{' '}
                <kbd className="rounded border border-neutral-300 bg-neutral-50 px-1 py-0.5 font-mono text-xs dark:border-neutral-700 dark:bg-neutral-900">
              ...
              <tbody className="text-neutral-700 dark:text-neutral-300">
                ...
                <tr>
                  ...
                  <td className="py-1">
                    ...
                    ,{' '}
                    <code className="rounded bg-neutral-100 px-1 py-0.5 font-mono text-xs dark:bg-neutral-800">
                      id=&quot;command-palette-option-$&#123;href&#125;&quot;
                    </code>
                  </td>
                </tr>
              </tbody>
